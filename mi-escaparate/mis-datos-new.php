...
<body id="panel">
						  ...
						  <div class="card card-body">
							<form method="post" accept-charset="UTF-8" id="cuenta">
								...
								<div class="form-group">
									<label for="nombre_tienda">Nombre de la empresa:</label>
					...
					<div class="col-xl-8 col-lg-10 col-md-10 col-sm-12 offset-xl-2 offset-lg-1 offset-md-1 offset-sm-0 card-header lista-prodcutos">
						<div class="box-status">
							...
							<div class="row">
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<h5>Logo:</h5>
									<img src="<?php echo SITE.'img/tiendas/'.NICKTIENDA.'/'.$logo_tienda?>" class="img-fluid" onerror="this.src='<?php echo SITE?>img/prevtallas.jpg'" id="preview-logo_tienda">
								</div>
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<h5>Portada:</h5>
									<img src="<?php echo SITE.'img/tiendas/'.NICKTIENDA.'/'.$cover_tienda?>" class="img-fluid" onerror="this.src='<?php echo SITE?>img/prevtallas.jpg'" id="preview-cover_tienda">
								</div>
							</div>
						</div>
						<!--EDITOR-->
								...
								<div class="row">
									...
									<div class="col-12" style="height: 15px"></div>
										<div class="col-md-6 col-sm-12">
											...
											<img class="card-img-top" src="<?php echo SITE.'img/tiendas/'.NICKTIENDA.'/'.$logo_tienda?>" alt="Imagen" id="img-logo_tienda" onerror="this.src='<?php echo SITE.'img/default-image-product.jpg'?>';">
											...
											<input type="hidden" name="txt-logo_tienda" id="txt-logo_tienda" value="<?php echo $logo_tienda?>" required title="Por favor agrega tu logo.">
											<input type="hidden" name="old-logo_tienda" id="old-logo_tienda" value="<?php echo $logo_tienda?>">
										</div>
										<div class="col-md-6 col-sm-12">
											<label class="label" data-toggle="tooltip" title="Portada de escaparate:">
											<img class="card-img-top" src="<?php echo SITE.'img/tiendas/'.NICKTIENDA.'/'.$cover_tienda?>" alt="Imagen" id="img-cover_tienda" onerror="this.src='<?php echo SITE.'img/default-image-product.jpg'?>';">
											...
											<span>*Imagen requerida</span>
											<input type="hidden" name="txt-cover_tienda" id="txt-cover_tienda" value="<?php echo $cover_tienda?>" required title="Por favor agrega tu portada.">
											<input type="hidden" name="old-cover_tienda" id="old-cover_tienda" value="<?php echo $cover_tienda?>">
										</div>
								</div>
								<div class="form-group">
	...
	<script>
		...
		function actualizardatos(act){
			...
			var url ="<?php echo SITE.'mi-escaparate/functions/actualizardatos-new.php?action='?>"+act;
		...
		$( ".inputimg" ).change(function(e) {
			...
			preview = document.getElementById('preview-'+imgid);
			input = element;
			dataimg = imgid;

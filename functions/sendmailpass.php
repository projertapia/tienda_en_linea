<?php
	function sendmailpass($mail,$clave){
		$to = $mail;
		$subject = 'Ecommerce, restablecer tu contraseña';
...
<tr><td><p style="margin: 5px 15px"><a href="'.SITEUSER.'recuperar/'.$clave.'" target="_blank">'.SITEUSER.'recuperar/'.$clave.'</a></p></td></tr>

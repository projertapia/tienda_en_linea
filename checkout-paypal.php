...
<body>	
	...
	<section id="carrito">
		<form method="post" accept-charset="UTF-8">
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-3 col-sm-6 hidden-sm-down">
						<div class="d-flex h-100">
							<div class="justify-content-center align-self-center">
								...
								<hr>
								<div id="adddireccion">
									<a data-toggle="modal" data-target="#nuevadireccion" style="cursor: pointer">Agregar dirección</a>
									|
									<a href="<?php echo $urlserver.'mis-direcciones'?>">Mis direcciones</a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-5 col-sm-6">
						<?php
									...
									$sqlcarrito ="SELECT c.id_carrito, c.clave_carrito, c.id_user_carrito, c.status_carrito, c.id_producto_carrito, c.id_vendedor_carrito, c.precioart_carrito, c.cantidad_producto_carrito, c.color_producto_carrito, c.talla_producto_carrito, c.notas_carrito,
									p.id_producto, p.nombre_producto, p.img_a_producto, p.id_tienda_producto, p.precio_producto, p.precio_promo_producto, p.talla_producto, p.color_tallas, p.activo_producto, p.tarifa_envio_producto, p.costo_envio_productos,
								...
								<?php
									while($result = mysqli_fetch_object($req)){
										...
										$costo_envio_productos = $result->costo_envio_productos;
					...
					<div class="col-lg-4 col-md-4 col-sm-6" id="ticket-carrito">
						<div class="d-flex h-100">
										...
										<tbody id="list-ticket">
											...
											<tr>
												<td colspan="2">
													...
													<script src="https://www.paypal.com/sdk/js?client-id={CLIENT-ID}&currency=MXN&locale=es_MX&merchant-id={merchant-id}" data-sdk-integration-source="button-factory" data-page-type="checkout" data-order-id="<?php echo $clave_carrito?>" ></script>
													<script>
													  paypal.Buttons({
														  style: {
															  shape: 'rect',
														  ...
														  onApprove: function(data, actions) {
															  return actions.order.capture().then(function(details) {
																  ...
																  alert(data.orderID);
																   window.location = "<?php echo $urlserver?>functions/autorizacion.php?&orderID="+data.orderID;
															  });

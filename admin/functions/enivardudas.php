...
//PARA TIENDA
$to = $email_tienda;
$subject = 'Has recibido un mensaje de administración de Ecommerce - Pedido:'.$idCarrito;
...
<table width="600px" align="center" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="font-family:Ember,Arial,sans-serif;">
	...
	<tr><td valign="middle" height="25px" align="center"><h3 style="margin: 10px 0 0 5px">Has recibido un mensaje del adminitrador '.$nombre_admin.'</h3></td></tr>
	<tr><td align="center"><p>Número de pedido: '.$idCarrito.'</p></td></tr>
	<tr><td align="center"><p>Nombre del cliente: '.$nombre_cliente.'</p></td></tr>
	...
	<tr><td height="25px"></td></tr>
	<tr><td>
		<h3 style="margin-left: 15px">Nombre administrador: '.$nombre_admin.'</h3>

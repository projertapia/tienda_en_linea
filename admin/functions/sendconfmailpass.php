<?php
	function sendmailcf($mailFC,$pass){
		$toFC = $mailFC;
		$subjectFCTXT = 'Ecommerce, su contraseña se cambio.';
...
<tr><td><h2 style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Hola</h2></td></tr>
<tr><td><p style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Se cambio exitósamente su contraseña.</p></td></tr>

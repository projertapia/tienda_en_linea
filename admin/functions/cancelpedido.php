...
$subjectTXT = 'Lo sentimos. El administrador '.$nombre_admin.' ha solicitado cancelar parte de su pedido #'.$idCarrito;
...
<table width="600px" align="center" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="font-family:Ember,Arial,sans-serif;">
	...
	<a href="'.SITE.'" target="_blank"><img src="'.SITE.'img/ecommerce_logo-ml.jpg" width="67"></a>
	</td></tr>
	<tr><td style="border-bottom: 1pt solid black;"></td></tr>
	<tr><td height="15px"></td></tr>
	<tr><td valign="middle" height="25px" align="center"><h3 style="margin: 10px 15px 15px 5px">Lo sentimos. El administrador '.$nombre_admin.' ha solicitado cancelar parte de su pedido #'.$idCarrito.'</h3></td></tr>
	...
	<tr><td>
		...
		<td>
		<img style="float:left" src="'.SITE.'img/tiendas/'.$nick_tienda.'/'.$img_a_producto.'" alt="product image" width="80px"> 
		</td>
		<td>
	...
	<tr><td height="25px"></td></tr>
	<tr><td>
		<h3 style="margin-left: 15px">Nombre completo del cliente: '.$nombre_completo.'</h3>
		<h4 style="margin-left: 15px">Razón de la cancelación del administrador: '.$razon.'.</h4>
	...
	<tr><td>
		<table width="100%" align="center" cellspacing="0" cellpadding="10" style="color:#000000;font-family:Ember,Arial,sans-serif;font-size:13px">
			<tbody>
				<tr>
					<td valign="middle" height="80px" width="350px"><a href="'.SITE.'" target="_blank"><img src="'.SITE.'img/ecommerce_logo-ml.jpg" width="67"></a></td>
					<td align="center">
...
//PARA CLIENTE
$toC = $email_cliente;
$subjectC = 'Hola '.$nombre_cliente.' lamentamos informar que parte de tu pedio #'.$idCarrito.' fue cancelado.';
...
<table width="600px" align="center" cellspacing="0" cellpadding="0" bgcolor="#ffffff" style="font-family:Ember,Arial,sans-serif;">
	...
	<tr><td style="border-bottom: 1pt solid black;"></td></tr>
	<tr><td height="15px"></td></tr>
	<tr><td valign="middle" height="25px" align="center"><h3 style="margin: 10px 15px 15px 5px">Hola '.$nombre_cliente.' lamentamos informarte que parte de tu pedio fue cancelado, a continuacióin te detallamos la razón y que producto no podra ser completado. No se requiere ninguna otra acción por tu parte. El vendedor se comunicará contigo si tiene alguna pregunta o comentario. No te preocupes se te devolvera el importe parcial de tu pedio.</h3></td></tr>
	<tr><td align="center"><p>Número de pedido: '.$idCarrito.'</p></td></tr>
	<tr><td height="10px"></td></tr>
	<tr><td align="center"><p>Fecha de pedido: '.$fechaPag.'</p></td></tr>
	<tr><td height="25px"></td></tr>

<?php
	function sendmailna($mailFC,$pass){
		$toFC = $mailFC;
		$subjectFCTXT = 'Bienvenido nuevo administrador de Ecommerce.';
		$subjectFC="=?UTF-8?B?".base64_encode($subjectFCTXT)."=?=";
...
<tr><td><p style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Aquí tienes tu usuario y contraseña como administrador de Ecommerce.</p></td></tr>
<tr><td><p style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Uusuario:'.$mailFC.'</p></td></tr>
<tr><td><p style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Su nueva contraseña es:'.$pass.'</p></td></tr>
<tr><td><p style="margin: 5px 15px; font-family:Ember,Arial,sans-serif;">Ingresa a tu cuenta <a href="'.SITE.'admin/entrar" title="Entrar" target="_blank">aquí.</a>.</p></td></tr>

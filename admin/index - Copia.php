...
<body id="panel">
					...
					<div class="col-12">
						<div class="card-header lista-prodcutos box-status">
							...
							<table class="table table-striped" id="productslist">
								<thead>
									<tr>
										...
										<th scope="col" class="hidden-row">Categorías</th>
							...
							<tr>
								...
								<td class="hidden-row"><?php echo $categoria_producto?></td>
						...
						<div class="card-header lista-prodcutos box-status">
							...
							<table class="table table-striped" id="productslist">
								<thead>
									...
									<tbody>
										<?php
											$SQLMasVendido="SELECT c.color_producto_carrito, c.id_vendedor_carrito, c.id_producto_carrito, COUNT(c.cantidad_producto_carrito) AS total, c.talla_producto_carrito,
											p.id_producto, p.nombre_producto, p.img_a_producto, p.codigo_producto,
											t.id_tienda, t.nombre_tienda, t.nick_tienda, t.categoria_tienda
											FROM carrito c, productos p, tiendas t
											WHERE c.id_vendedor_carrito = t.id_tienda AND c.id_producto_carrito = p.id_producto AND (c.status_carrito = 1 OR c.status_carrito = 2) GROUP BY c.id_producto_carrito ORDER BY total DESC LIMIT 10";
    ...
    $("#menu-toggle").click(function(e) {
      e.preventDefault();
      $("#home-mi-escaparate").toggleClass("toggled");
    });
  </script>
</body>
</html>
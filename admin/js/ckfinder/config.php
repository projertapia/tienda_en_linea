...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',	
	'baseUrl'      => 'https://ecommerce.com/img',
   //'baseUrl'      => 'http://localhost/elpais/img/site',
	//'root'         => 'img/site', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0755,
    'chmodFolders' => 0755,
...
$config['backends'][] = array(
	...
	'host'         => 'ftp.host.com',
    'baseUrl'      => 'img/site',
	'username'     => 'filespais@ecommerce.com',
     'password'     => '~;F;_ZeHAVBA',
	//'root'         => 'img/site', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0755,
    'chmodFolders' => 0755,
